function index = get_indices_rec(n_bus,n_macs,n_branches,n_shunts,opt)
% usage: index = get_indices_rec(n_bus,n_macs,n_branches,n_shunts,interleave)
...
if interleave
    index.y.Vr   = (1:2:2*n_bus);
    index.y.Vi   = (2:2:2*n_bus); 
else
    index.y.Vr   = (1:n_bus);
    index.y.Vi   = (1:n_bus) + n_bus;
end
...
index.g.P       = index.y.Vr;
index.g.Q       = index.y.Vi;
if ~angle_ref
