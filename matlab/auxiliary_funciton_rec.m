function [ output ] = auxiliary_funciton_rec(local_id,ix,ps,opt)
% usage: [ global_relay_id ] = auxiliary_funciton_rec(local_id,ix,ps,opt)
...
elseif ix && isempty(local_id)
    ...
    output      = get_indices_rec(n,ng,m,n_sh,opt);
end
end