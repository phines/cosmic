function [tdelay_UFLS_relay] = tdelay_UFLS_relay(zero_crossing)
% usage: [tdelay_temp_relay] = tdelay_UFLS_relay(zero_crossing)
...
tdelay_UFLS_relay = t_temp(zero_crossing);
