function [F, dF_dxy, dF_dxyp] = differential_algebraic_i_rec(t,xy,xyp,ps,opt)
...
% inputs:
%   t   -> time in seconds
%   xy  -> [delta omega Pm Eap E1 Efd temp Vr Vi]
%   xyp -> xy'
...
[f,df_dx,df_dy] = differential_eqs_rec(t,x,y,ps,opt);
[g,dg_dx,dg_dy] = algebraic_eqs_rec(t,x,y,ps,opt);
