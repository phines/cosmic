function y_new = solve_algebraic_rec(t,x,y,ps,opt)
% usage: y_new = solve_algebraic_rec(t,x,y,ps,opt) for rectangular
% formulation.
...
g_handle = @(y) algebraic_eqs_only_rec(t,x,y,ps,opt);
