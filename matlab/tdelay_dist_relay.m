function [tdelay_dist_relay] = tdelay_dist_relay(zero_crossing)
% usage: [tdelay_temp_relay] = tdelay_dist_relay(zero_crossing)
...
tdelay_dist_relay = t_temp(zero_crossing);