            ...
            set1 = P2 > Pmin & P2 < Pmin + 0.05*(Pmax - Pmin);                     % This is the region [Pmin Pmin+0.05*(Pmax-Pmin)], first 
            ...
            set1 = P2 < Pmax & P2 > Pmin + 0.95*(Pmax - Pmin);                     % The region [Pmin+0.95*(Pmax-Pmin) Pmax]
